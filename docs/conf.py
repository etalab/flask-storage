...
latex_documents = [
    ("index", "Flask-FS.tex", "Flask-FS Documentation", "Axel Haustant", "manual"),
]
...
man_pages = [("index", "flask-storages", "Flask-FS Documentation", ["Axel Haustant"], 1)]
